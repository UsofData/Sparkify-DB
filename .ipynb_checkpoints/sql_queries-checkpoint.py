...
(user_id int, first_name varchar, last_name varchar, gender char (1), level varchar)
""")
...
(artist_id varchar, name varchar, location varchar, latitude decimal (8,6) , longitude decimal (9,6))
""")

time_table_create = ("""create table time
(start_time time, hour int, day int, month int, week int, year int, weekday varchar)
""")
